...
typedef struct
{
  BSP_UART_t id_;
  size_t last_rx_pos_;
  BSP_UART_RawData_t dma_buff_rx_;
  UART_HandleTypeDef *uart_handle_;
  STM32UART_RxCallback_t rx_callback_;
  err_t last_error_;
} STM32UART_t;
...
typedef struct
{
  BSP_UART_t id_;
  size_t last_tx_pos_;
  BSP_UART_RawData_t dma_buff_0_;
  BSP_UART_RawData_t dma_buff_1_;
  UART_HandleTypeDef *uart_handle_;
  STM32UART_TxCompleteCallback_t tx_callback_;
  err_t last_error_;
  volatile uint8_t active_buf_;
  volatile size_t pending_size_;
